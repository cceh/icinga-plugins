...
parser.add_argument(
    "-w", "--warning", type=int, default=90, help="the warning level (default: 90%)"
)
parser.add_argument(
    "-c", "--critical", type=int, default=95, help="the critical level (default: 95%)"
)
...
perfdata = " - %.1f%% free | memory=%.2f%%;%.2f;%.2f;%.2f;%.2f" % (
    free,
    used,
    args.warning,
    args.critical,
